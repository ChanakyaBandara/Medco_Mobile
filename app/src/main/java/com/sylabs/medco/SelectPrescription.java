...
public class SelectPrescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            PHID= (String) savedInstanceState.getSerializable("PHID");
        }

        HashMap<String, String> param = new HashMap<String, String>();
        param.put("type", "load_select_prescription");
        ...
        Backgroundworker backgroundworker = new Backgroundworker(SelectPrescription.this);
    ...
    public void displayName(String result) {
        ...
        try {
            ...
            if (dataListID.isEmpty()) {
                ...
                new Recycleview_config_select_prescriptions().setConfig(recyclerView, PHID, SelectPrescription.this, dataList, dataListID);
            }
